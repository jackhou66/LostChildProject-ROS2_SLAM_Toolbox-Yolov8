...
#include "msg_interface/msg/detail/arithmetic__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const msg_interface::msg::Arithmetic *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_interface::msg::Arithmetic *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Arithmetic__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const msg_interface::msg::Arithmetic *>(
...
{
  return max_serialized_size_Arithmetic(full_bounded, 0);
}

static message_type_support_callbacks_t _Arithmetic__callbacks = {
  "msg_interface::msg",
  "Arithmetic",
...
static rosidl_message_type_support_t _Arithmetic__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Arithmetic__callbacks,
...
{
  return &msg_interface::msg::typesupport_fastrtps_cpp::_Arithmetic__handle;
}
